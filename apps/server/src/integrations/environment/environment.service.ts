...
export class EnvironmentService {
  ...
  getPort(): number {
    return Number.parseInt(this.configService.get<string>("PORT", "3000"));
  }
  ...
  getSmtpPort(): number {
    return Number.parseInt(this.configService.get<string>("SMTP_PORT"));
  }
  ...
  getBillingTrialDays(): number {
    return Number.parseInt(
      this.configService.get<string>("BILLING_TRIAL_DAYS", "14")
    );
  }
