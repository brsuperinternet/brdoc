...
export class LabelRepo {
  ...
  async findLabelsByPageId(pageId: string, pagination: PaginationOptions) {
    ...
    const result = await executeWithCursorPagination(query, {
      ...
      fields: [
        { direction: "asc", expression: "pageLabels.id", key: "joinId" },
      ],
      parseCursor: (cursor) => ({
  ...
  async findPagesByLabelId(
    ...
    return executeWithCursorPagination(query, {
      ...
      fields: [
        { direction: "desc", expression: "pages.updatedAt", key: "updatedAt" },
        { direction: "desc", expression: "pages.id", key: "id" },
      ],
      parseCursor: (cursor) => ({
        id: cursor.id,
